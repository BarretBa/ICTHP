...
class DeepSpeedAccelerator(BaseAccelerator):
    def __init__(self, cfg: DeepSpeedAcceleratorConfig):
        ...
        deepspeed_plugin = DeepSpeedPlugin(
            hf_ds_config=OmegaConf.to_container(self.cfg.deepspeed, resolve=True),  #将 self.cfg.deepspeed（即 DeepSpeedConfig 实例）转化为一个 Python 字典，并解析所有引用
